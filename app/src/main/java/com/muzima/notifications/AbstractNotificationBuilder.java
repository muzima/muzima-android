...
public class AbstractNotificationBuilder extends NotificationCompat.Builder {
    ...
    protected CharSequence getStyledMessage(@NonNull SignalRecipient recipient, @Nullable CharSequence message) {
    ...
    public void setTicker(@NonNull SignalRecipient recipient, @Nullable CharSequence message) {
