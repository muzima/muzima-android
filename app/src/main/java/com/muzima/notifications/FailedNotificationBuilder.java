...
public class FailedNotificationBuilder extends AbstractNotificationBuilder {
    ...
    public FailedNotificationBuilder(Context context, NotificationPrivacyPreference privacy, Intent intent) {
        ...
        setContentTitle(context.getString(R.string.general_message_delivery_failed));
        setContentText(context.getString(R.string.general_failed_to_deliver_message));
        setTicker(context.getString(R.string.error_delivering_message));
