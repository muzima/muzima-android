...
public class NotificationChannels {
     ...
     */
    public static @NonNull String getChannelDisplayNameFor(@NonNull Context context, @Nullable String systemName, @Nullable String profileName, @NonNull SignalAddress address) {
        if (!TextUtils.isEmpty(systemName)) {
            ...
            return context.getString(R.string.notification_channel_missing_display_name);
        }
    }
     ...
     */
    public static String createChannelFor(@NonNull Context context, @NonNull SignalRecipient recipient) {
    ...
    /**
     * More verbose version of {@link #createChannelFor(Context, SignalRecipient)}.
     */
    public static @Nullable String createChannelFor(@NonNull Context context,
                                                    @NonNull SignalAddress address,
     ...
     */
    public static void deleteChannelFor(@NonNull Context context, @NonNull SignalRecipient recipient) {
        if (!supported()) {
            return;
        }
    ...
    Uri getMessageRingtone(@NonNull Context context, @NonNull SignalRecipient recipient) {
        ...
        if (!channelExists(channel)) {
            Log.w(TAG, "SignalRecipient had no channel. Returning null.");
            return null;
        }
     ...
     */
    @WorkerThread
    public static void updateMessageRingtone(@NonNull Context context, @NonNull SignalRecipient recipient, @Nullable Uri uri) {
        if (!supported() || recipient.getNotificationChannel() == null) {
            return;
        }
     ...
     */
    public static boolean getMessageVibrate(@NonNull Context context, @NonNull SignalRecipient recipient) {
        if (!supported()) {
        ...
        if (!channelExists(channel)) {
            Log.w(TAG, "SignalRecipient didn't have a channel. Returning message default.");
            return getMessageVibrate(context);
        }
     ...
     */
    @WorkerThread
    public static void updateMessageVibrate(@NonNull Context context, @NonNull SignalRecipient recipient, VibrateState vibrateState) {
        if (!supported() || recipient.getNotificationChannel() == null) {
            return ;
        }
     ...
     */
    public static void updateContactChannelName(@NonNull Context context, @NonNull SignalRecipient recipient) {
        if (!supported() || recipient.getNotificationChannel() == null) {
            return;
        }
    ...
    private static void onCreate(@NonNull Context context, @NonNull NotificationManager notificationManager) {
        NotificationChannelGroup messagesGroup = new NotificationChannelGroup(CATEGORY_MESSAGES, context.getResources().getString(R.string.notification_channel_group_messages));
        notificationManager.createNotificationChannelGroup(messagesGroup);

        NotificationChannel messages     = new NotificationChannel(getMessagesChannel(context), context.getString(R.string.notification_channel_messages), NotificationManager.IMPORTANCE_HIGH);
        NotificationChannel calls        = new NotificationChannel(CALLS, context.getString(R.string.notification_channel_calls), NotificationManager.IMPORTANCE_LOW);
        NotificationChannel failures     = new NotificationChannel(FAILURES, context.getString(R.string.notification_channel_failures), NotificationManager.IMPORTANCE_HIGH);
        NotificationChannel backups      = new NotificationChannel(BACKUPS, context.getString(R.string.notification_channel_backups), NotificationManager.IMPORTANCE_LOW);
        NotificationChannel lockedStatus = new NotificationChannel(LOCKED_STATUS, context.getString(R.string.notification_channel_locked_status), NotificationManager.IMPORTANCE_LOW);
        NotificationChannel other        = new NotificationChannel(OTHER, context.getString(R.string.notification_channel_other), NotificationManager.IMPORTANCE_LOW);
        ...
        if (BuildConfig.PLAY_STORE_DISABLED) {
            NotificationChannel appUpdates = new NotificationChannel(APP_UPDATES, context.getString(R.string.notification_channel_app_updates), NotificationManager.IMPORTANCE_HIGH);
    ...
    private static @NonNull String generateChannelIdFor(@NonNull SignalAddress address) {
