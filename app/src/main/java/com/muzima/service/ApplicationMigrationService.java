...
import com.muzima.messaging.sqlite.database.SmsMigrator;
import com.muzima.messaging.sqlite.database.SmsMigrator.ProgressDescription;
...
public class ApplicationMigrationService extends Service
    ...
    public static final String MIGRATE_DATABASE = "com.muzima.ApplicationMigration.MIGRATE_DATABSE";
    public static final String COMPLETED_ACTION = "com.muzima.ApplicationMigrationService.COMPLETED";
    ...
    private class ImportRunnable implements Runnable {
        ...
        public void run() {
            ...
            PowerManager.WakeLock wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Migration");
