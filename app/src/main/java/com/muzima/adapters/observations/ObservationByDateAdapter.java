...
public class ObservationByDateAdapter extends RecyclerAdapter<ObservationByDateAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.timeline, parent, false));
    }
    ...
    private void bindViews(@NonNull ObservationByDateAdapter.ViewHolder holder, int position) {
