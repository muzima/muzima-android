...
public class EncountersByPatientAdapter2 extends RecyclerAdapter<EncountersByPatientAdapter2.ViewHolder> {
    ...
    public EncountersByPatientAdapter2(Context context, String patientUuid, EncounterClickedListener encounterClickedListener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerAdapter.ViewHolder holder, int position) {
        bindViews((EncountersByPatientAdapter2.ViewHolder) holder, position);
    }

    private void bindViews(@NotNull EncountersByPatientAdapter2.ViewHolder holder, int position) {
