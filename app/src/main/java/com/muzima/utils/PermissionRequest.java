...
public class PermissionRequest {
    ...
    PermissionRequest(@Nullable Runnable allGrantedListener,
    ...
    void onResult(String[] permissions, int[] grantResults, boolean[] shouldShowRationaleDialog) {
        ...
        if (denied.size() > 0) {
            ...
            if (someDeniedListener != null) if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
        ...
        if (permanentlyDenied.size() > 0) {
            ...
            if (somePermanentlyDeniedListener != null) if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
