package com.muzima.messaging.qr;
...
import com.muzima.messaging.CameraView;
import com.muzima.messaging.CameraView.PreviewFrame;
import com.muzima.messaging.ScanListener;
...
/**
 * Implementation is based and dependent on
 * com.google.zxing.qr and zxing core
 */
...
public class ScanningThread extends Thread implements CameraView.PreviewCallback {
    ...
    private @Nullable
    String getScannedData(byte[] data, int width, int height, int orientation) {
        try {
        ...
        } catch (NullPointerException | ChecksumException e) {
            Log.w(TAG, e);
        } catch (Resources.NotFoundException e) {
        } catch (com.google.zxing.FormatException | NotFoundException e) {
            e.printStackTrace();
        }
