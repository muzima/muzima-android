...
import com.muzima.R;
import com.muzima.messaging.components.KeyboardAwareLinearLayout;
...
public class QuickAttachmentDrawer extends ViewGroup implements InputAwareLayout.InputView, CameraView.CameraViewListener {
    ...
    private void slideTo(int slideOffset, boolean forceInstant) {
        ...
        if (!forceInstant) {
            animator = com.nineoldandroids.animation.ObjectAnimator.ofInt(this, "slideOffset", this.slideOffset, slideOffset);
