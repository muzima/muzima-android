...
import com.muzima.messaging.contactshare.Contact.Avatar;
import com.muzima.messaging.contactshare.Contact.Phone;
import com.muzima.messaging.contactshare.Contact.Email;
import com.muzima.messaging.contactshare.Contact.PostalAddress;
...
public class ContactRepository {
    ...
    @WorkerThread
    private @Nullable
    Contact getContactFromSystemContacts(long contactId) {
    ...
    @WorkerThread
    private @Nullable
    Contact getContactFromVcard(@NonNull Uri uri) {
    ...
    @WorkerThread
    private @NonNull
    List<Phone> getPhoneNumbers(long contactId) {
    ...
    @WorkerThread
    private @NonNull
    List<Email> getEmails(long contactId) {
    ...
    @WorkerThread
    private @NonNull
    List<PostalAddress> getPostalAddresses(long contactId) {
    ...
    @WorkerThread
    private @Nullable
    AvatarInfo getAvatarInfo(long contactId, List<Phone> phoneNumbers) {
        ...
        for (Phone phoneNumber : phoneNumbers) {
            AvatarInfo recipientAvatar = getRecipientAvatarInfo(SignalAddress.fromExternal(context, phoneNumber.getNumber()));
    ...
    @WorkerThread
    private @Nullable
    AvatarInfo getSystemAvatarInfo(long contactId) {
    ...
    @WorkerThread
    private @Nullable
    AvatarInfo getRecipientAvatarInfo(@NonNull SignalAddress address) {
