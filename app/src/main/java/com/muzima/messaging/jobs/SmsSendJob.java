...
import com.muzima.messaging.jobs.requirements.NetworkOrServiceRequirement;
import com.muzima.messaging.jobs.requirements.ServiceRequirement;
...
import com.muzima.service.SmsDeliveryListener;
...
public class SmsSendJob extends SendJob {
    ...
    private void deliver(SmsMessageRecord message)
        ...
        try {
            ...
            warn(TAG, npe);
            log(TAG, "SignalRecipient: " + recipient);
