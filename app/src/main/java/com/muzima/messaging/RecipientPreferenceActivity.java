...
import com.muzima.messaging.customcomponents.ThreadPhotoRailView;
...
import com.muzima.messaging.preference.ColorPickerPreference;
import com.muzima.messaging.preference.ContactPreference;
import com.muzima.messaging.preference.SwitchPreferenceCompat;
...
import com.muzima.messaging.sqlite.database.loaders.ThreadMediaLoader;
...
public class RecipientPreferenceActivity extends PassphraseRequiredActionBarActivity implements RecipientModifiedListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onCreate(Bundle instanceState, boolean ready) {
        ...
        SignalRecipient recipient = SignalRecipient.from(this, address, true);
    ...
    private void initializeToolbar() {
        ...
        this.toolbarLayout.setExpandedTitleColor(getResources().getColor(R.color.primary_white));
        this.toolbarLayout.setCollapsedTitleTextColor(getResources().getColor(R.color.primary_white));
    ...
    private void setHeader(@NonNull SignalRecipient recipient) {
    ...
    public static class RecipientPreferenceFragment
        ...
        private void initializeRecipients() {
            this.recipient = SignalRecipient.from(getActivity(), getArguments().getParcelable(ADDRESS_EXTRA), true);
            this.recipient.addListener(this);
        }

        private void setSummaries(SignalRecipient recipient) {
        ...
        private @NonNull
        String formatAddress(@NonNull SignalAddress address) {
        ...
        private class MuteClickedListener implements Preference.OnPreferenceClickListener {
            ...
            private void setMuted(@NonNull final Context context, final SignalRecipient recipient, final long until) {
