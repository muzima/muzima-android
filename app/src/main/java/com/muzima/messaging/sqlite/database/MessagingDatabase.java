...
import com.muzima.messaging.sqlite.database.documents.Document;
...
public abstract class MessagingDatabase extends Database implements MmsSmsColumns {
    ...
    public void setMismatchedIdentity(long messageId, final SignalAddress address, final IdentityKey identityKey) {
    ...
    public void addMismatchedIdentity(long messageId, SignalAddress address, IdentityKey identityKey) {
        try {
    ...
    public void removeMismatchedIdentity(long messageId, SignalAddress address, IdentityKey identityKey) {
        try {
