...
public class ContactsDatabase {
    ...
    public synchronized void setRegisteredUsers(@NonNull Account account,
                                                @NonNull List<SignalAddress> registeredAddressList,
                                                boolean remove)
            throws RemoteException, OperationApplicationException
    {
        ...
        for (Map.Entry<SignalAddress, SignalContact> currentContactEntry : currentContacts.entrySet()) {
    ...
    private void addContactVoiceSupport(List<ContentProviderOperation> operations,
                                        @NonNull SignalAddress address, long rawContactId)
    {
        operations.add(ContentProviderOperation.newUpdate(ContactsContract.RawContacts.CONTENT_URI)
    ...
    private @NonNull Map<SignalAddress, SignalContact> getSignalRawContacts(@NonNull Account account) {
        Uri currentContactsUri = ContactsContract.RawContacts.CONTENT_URI.buildUpon()
                .appendQueryParameter(ContactsContract.RawContacts.ACCOUNT_NAME, account.name)
    ...
    private Optional<SystemContactInfo> getSystemContactInfo(@NonNull SignalAddress address)
    {
