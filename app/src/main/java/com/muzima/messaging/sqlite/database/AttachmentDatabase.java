...
import com.muzima.messaging.crypto.ClassicDecryptingPartInputStream;
import com.muzima.messaging.crypto.ModernDecryptingPartInputStream;
import com.muzima.messaging.crypto.ModernEncryptingPartOutputStream;
...
import com.muzima.messaging.video.EncryptedMediaDataSource;
import com.muzima.utils.BitmapUtil;
import com.muzima.utils.JsonUtils;
import com.muzima.utils.MediaUtil;
import com.muzima.utils.MediaUtil.ThumbnailData;
...
public class AttachmentDatabase extends Database {
    ...
    public @NonNull
    Attachment updateAttachmentData(@NonNull Attachment attachment,
    ...
    private @NonNull
    DataInfo setAttachmentData(@NonNull File destination, @NonNull InputStream in)
            throws MmsException {
        try {
