...
public class RecipientDatabase extends Database {
    ...
    public Optional<RecipientSettings> getRecipientSettings(@NonNull SignalAddress address) {
        SQLiteDatabase database = databaseHelper.getReadableDatabase();
        Cursor         cursor   = null;
    ...
    public void setColor(@NonNull SignalRecipient recipient, @NonNull MaterialColor color) {
    ...
    public void setDefaultSubscriptionId(@NonNull SignalRecipient recipient, int defaultSubscriptionId) {
        ContentValues values = new ContentValues();
    ...
    public void setBlocked(@NonNull SignalRecipient recipient, boolean blocked) {
        ContentValues values = new ContentValues();
    ...
    public void setMessageRingtone(@NonNull SignalRecipient recipient, @Nullable Uri notification) {
        ContentValues values = new ContentValues();
    ...
    public void setCallRingtone(@NonNull SignalRecipient recipient, @Nullable Uri ringtone) {
        ContentValues values = new ContentValues();
    ...
    public void setMessageVibrate(@NonNull SignalRecipient recipient, @NonNull VibrateState enabled) {
        ContentValues values = new ContentValues();
    ...
    public void setCallVibrate(@NonNull SignalRecipient recipient, @NonNull VibrateState enabled) {
        ContentValues values = new ContentValues();
    ...
    public void setMuted(@NonNull SignalRecipient recipient, long until) {
        ContentValues values = new ContentValues();
    ...
    public void setSeenInviteReminder(@NonNull SignalRecipient recipient, @SuppressWarnings("SameParameterValue") boolean seen) {
    ...
    public void setExpireMessages(@NonNull SignalRecipient recipient, int expiration) {
    ...
    public void setUnidentifiedAccessMode(@NonNull SignalRecipient recipient, @NonNull UnidentifiedAccessMode unidentifiedAccessMode) {
        ContentValues values = new ContentValues(1);
    ...
    public void setProfileKey(@NonNull SignalRecipient recipient, @Nullable byte[] profileKey) {
        ContentValues values = new ContentValues(1);
    ...
    public void setProfileName(@NonNull SignalRecipient recipient, @Nullable String profileName) {
        ContentValues contentValues = new ContentValues(1);
    ...
    public void setProfileAvatar(@NonNull SignalRecipient recipient, @Nullable String profileAvatar) {
        ContentValues contentValues = new ContentValues(1);
    ...
    public void setProfileSharing(@NonNull SignalRecipient recipient, @SuppressWarnings("SameParameterValue") boolean enabled) {
        ContentValues contentValues = new ContentValues(1);
    ...
    public void setNotificationChannel(@NonNull SignalRecipient recipient, @Nullable String notificationChannel) {
        ContentValues contentValues = new ContentValues(1);
    ...
    public void setRegistered(@NonNull SignalRecipient recipient, RegisteredState registeredState) {
        ContentValues contentValues = new ContentValues(1);
    ...
    public void setRegistered(@NonNull List<SignalAddress> activeAddresses,
                              @NonNull List<SignalAddress> inactiveAddresses)
    {
        for (SignalAddress activeAddress : activeAddresses) {
            ContentValues contentValues = new ContentValues(1);
            contentValues.put(REGISTERED, RegisteredState.REGISTERED.getId());

            updateOrInsert(activeAddress, contentValues);
            SignalRecipient.applyCached(activeAddress, recipient -> recipient.setRegistered(RegisteredState.REGISTERED));
        }

        for (SignalAddress inactiveAddress : inactiveAddresses) {
            ContentValues contentValues = new ContentValues(1);
            contentValues.put(REGISTERED, RegisteredState.NOT_REGISTERED.getId());

            updateOrInsert(inactiveAddress, contentValues);
            SignalRecipient.applyCached(inactiveAddress, recipient -> recipient.setRegistered(RegisteredState.NOT_REGISTERED));
        }
    }
    ...
    public List<SignalAddress> getRegistered() {
        ...
        try (Cursor cursor = db.query(TABLE_NAME, new String[] {ADDRESS}, REGISTERED + " = ?", new String[] {"1"}, null, null, null)) {
            while (cursor != null && cursor.moveToNext()) {
                results.add(SignalAddress.fromSerialized(cursor.getString(0)));
            }
        }
    ...
    public void updateSystemContactColors(@NonNull ColorUpdater updater) {
        ...
        try (Cursor cursor = db.query(TABLE_NAME, new String[] {ADDRESS, COLOR, SYSTEM_DISPLAY_NAME}, SYSTEM_DISPLAY_NAME + " IS NOT NULL AND " + SYSTEM_DISPLAY_NAME + " != \"\"", null, null, null, null)) {
            while (cursor != null && cursor.moveToNext()) {
                SignalAddress address = SignalAddress.fromSerialized(cursor.getString(cursor.getColumnIndexOrThrow(ADDRESS)));
            ...
            Stream.of(updates.entrySet()).forEach(entry -> {
                SignalRecipient.applyCached(entry.getKey(), recipient -> {
    ...
    public RegisteredState isRegistered(@NonNull SignalAddress address) {
        SQLiteDatabase db = databaseHelper.getReadableDatabase();
    ...
    private void updateOrInsert(SignalAddress address, ContentValues contentValues) {
        SQLiteDatabase database = databaseHelper.getWritableDatabase();
    ...
    public class BulkOperationsHandle {
        ...
        private final Map<SignalAddress, PendingContactInfo> pendingContactInfoMap = new HashMap<>();

        BulkOperationsHandle(SQLiteDatabase database) {
            this.database = database;
        }

        public void setSystemContactInfo(@NonNull SignalAddress address, @Nullable String displayName, @Nullable String photoUri, @Nullable String systemPhoneLabel, @Nullable String systemContactUri) {
            ContentValues contentValues = new ContentValues(1);
        ...
        public void finish() {
            ...
            Stream.of(pendingContactInfoMap.entrySet())
                    .forEach(entry -> SignalRecipient.applyCached(entry.getKey(), recipient -> {
    ...
    public static class RecipientReader implements Closeable {
        ...
        public @NonNull SignalRecipient getCurrent() {
            ...
            return SignalRecipient.from(context, SignalAddress.fromSerialized(serialized), false);
        }

        public @Nullable SignalRecipient getNext() {
            if (cursor != null && !cursor.moveToNext()) {
                return null;
            }
