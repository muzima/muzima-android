...
public class AlbumRailAdapter extends RecyclerView.Adapter<AlbumRailAdapter.AlbumRailViewHolder> {
    ...
    public static class AlbumRailViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(@NonNull MediaRecord record, boolean isActive, @NonNull GlideRequests glideRequests,
