...
public class OutgoingMediaMessage {
    ...
    public OutgoingMediaMessage(SignalRecipient recipient, String message,
    ...
    public OutgoingMediaMessage(SignalRecipient recipient, SlideDeck slideDeck, String message, long sentTimeMillis, int subscriptionId, long expiresIn, int distributionType, @Nullable QuoteModel outgoingQuote, @NonNull List<Contact> contacts) {
        this(recipient,
    ...
    public @NonNull
    List<NetworkFailure> getNetworkFailures() {
        return networkFailures;
    }

    public @NonNull
    List<IdentityKeyMismatch> getIdentityKeyMismatches() {
