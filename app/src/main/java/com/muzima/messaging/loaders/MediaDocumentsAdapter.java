package com.muzima.messaging.loaders;
...
import com.muzima.messaging.mms.DocumentSlide;
...
public class MediaDocumentsAdapter extends CursorRecyclerViewAdapter<MediaDocumentsAdapter.ViewHolder> implements StickyHeaderDecoration.StickyHeaderAdapter<MediaDocumentsAdapter.HeaderViewHolder> {
        ...
        if (slide != null && slide.hasDocument()) {
            ...
            viewHolder.documentView.setOnClickListener(view -> {
                ...
                try {
                    ...
                    Toast.makeText(getContext(), R.string.warning_unable_to_open_media, Toast.LENGTH_LONG).show();
                }
            });
        } else {
