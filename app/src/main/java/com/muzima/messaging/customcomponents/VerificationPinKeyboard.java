...
public class VerificationPinKeyboard extends FrameLayout {
    ...
    public ListenableFuture<Boolean> displaySuccess() {
        ...
        this.successView.getBackground().setColorFilter(getResources().getColor(R.color.cpb_green), PorterDuff.Mode.SRC_IN);
    ...
    public ListenableFuture<Boolean> displayFailure() {
        ...
        this.failureView.getBackground().setColorFilter(getResources().getColor(R.color.cpb_red_dark), PorterDuff.Mode.SRC_IN);
    ...
    public ListenableFuture<Boolean> displayLocked() {
        ...
        this.lockedView.getBackground().setColorFilter(getResources().getColor(R.color.cpb_green), PorterDuff.Mode.SRC_IN);
