...
import com.muzima.messaging.customcomponents.emoji.parsing.EmojiDrawInfo;
import com.muzima.messaging.customcomponents.emoji.parsing.EmojiPageBitmap;
import com.muzima.messaging.customcomponents.emoji.parsing.EmojiParser;
import com.muzima.messaging.customcomponents.emoji.parsing.EmojiTree;
...
public class EmojiProvider {
    ...
    class EmojiDrawable extends Drawable {
        ...
        public void setBitmap(Bitmap bitmap) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR1 || bmp == null || !bmp.sameAs(bitmap)) {
                bmp = bitmap;
                invalidateSelf();
            }
        }
