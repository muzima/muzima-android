...
public class EmojiVariationSelectorPopup extends PopupWindow {
    ...
    private final EmojiPageView.EmojiSelectionListener listener;

    public EmojiVariationSelectorPopup(@NonNull Context context, @NonNull EmojiPageView.EmojiSelectionListener listener) {
