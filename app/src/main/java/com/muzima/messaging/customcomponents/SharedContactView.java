...
import com.muzima.messaging.components.CornerMask;
...
public class SharedContactView extends LinearLayout implements RecipientModifiedListener {
    ...
    public interface EventListener {
        ...
        void onInviteClicked(@NonNull List<SignalRecipient> choices);
        void onMessageClicked(@NonNull List<SignalRecipient> choices);
    }
}
