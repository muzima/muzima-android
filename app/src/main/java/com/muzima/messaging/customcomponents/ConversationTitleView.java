...
public class ConversationTitleView extends RelativeLayout {
    ...
    public void setTitle(@NonNull GlideRequests glideRequests, @Nullable SignalRecipient recipient) {
    ...
    private void setComposeTitle() {
        this.title.setText(R.string.general_compose_message);
        this.subtitle.setText(null);
        this.subtitle.setVisibility(View.GONE);
    }

    private void setRecipientTitle(SignalRecipient recipient) {
    ...
    private void setGroupRecipientTitle(SignalRecipient recipient) {
        ...
        this.subtitle.setText(Stream.of(recipient.getParticipants())
                ...
                .map(SignalRecipient::toShortString)
    ...
    private void setNonContactRecipientTitle(SignalRecipient recipient) {
    ...
    private void setContactRecipientTitle(SignalRecipient recipient) {
        this.title.setText(recipient.getName());
