...
public class AvatarImageView extends AppCompatImageView {
    ...
    public void setAvatar(@NonNull GlideRequests requestManager, @Nullable SignalRecipient recipient, boolean quickContactEnabled) {
        if (recipient != null) {
    ...
    private void setAvatarClickHandler(final SignalRecipient recipient, boolean quickContactEnabled) {
