...
public class ConversationTypingView extends LinearLayout {
    ...
    public void setTypists(@NonNull GlideRequests glideRequests, @NonNull List<SignalRecipient> typists, boolean isGroupThread) {
        if (typists.isEmpty()) {
            indicator.stopAnimation();
            return;
        }

        SignalRecipient typist = typists.get(0);
