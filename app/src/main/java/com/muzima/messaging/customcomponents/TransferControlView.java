...
public class TransferControlView extends FrameLayout {
    ...
    public TransferControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            background.setColorFilter(0x66ffffff, PorterDuff.Mode.MULTIPLY);
        }
    ...
    private void display(@Nullable final View view) {
        ...
        if (current == view || current == null) {
            ...
            com.nineoldandroids.animation.Animator anim = getWidthAnimator(sourceWidth, targetWidth);
            anim.start();
        }
    ...
    private com.nineoldandroids.animation.Animator getWidthAnimator(final int from, final int to) {
        final com.nineoldandroids.animation.ValueAnimator anim = com.nineoldandroids.animation.ValueAnimator.ofInt(from, to);
