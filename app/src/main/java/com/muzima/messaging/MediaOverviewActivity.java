...
import com.muzima.R;
import com.muzima.adapters.media.MediaGalleryAdapter;
import com.muzima.messaging.loaders.MediaDocumentsAdapter;
...
public class MediaOverviewActivity extends PassphraseRequiredActionBarActivity {
    ...
    private class MediaOverviewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            args.putSerializable(MediaOverviewGalleryFragment.LOCALE_EXTRA, getResources().getConfiguration().locale);
