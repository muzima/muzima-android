...
import com.muzima.messaging.fragments.DeviceAddFragment;
...
public class DeviceActivity extends PassphraseRequiredActionBarActivity
    ...
    public void onCreate(Bundle bundle, boolean ready) {
        ...
        if (getIntent().getBooleanExtra("add", false)) {
            initFragment(android.R.id.content, deviceAddFragment, getResources().getConfiguration().locale);
        } else {
            initFragment(android.R.id.content, deviceListFragment, getResources().getConfiguration().locale);
        }
    }
