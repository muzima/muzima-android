...
import com.muzima.messaging.ConversationAdapter.ItemClickListener;
...
public class ConversationFragment extends Fragment
    ...
    private void initializeResources() {
        this.recipient = SignalRecipient.from(getActivity(), getActivity().getIntent().getParcelableExtra(ConversationActivity.ADDRESS_EXTRA), true);
        ...
        RecyclerView.OnScrollListener scrollListener = new ConversationScrollListener(getActivity());
    ...
    public void reload(SignalRecipient recipient, long threadId) {
...
//        });
    ...
    private class ConversationScrollListener extends RecyclerView.OnScrollListener {
        ...
        public ConversationScrollListener(@NonNull Context context) {
...
//                ActivityCompat.startActivity(getActivity(), SharedContactDetailsActivity.getIntent(getContext(), contact), bundle);
        ...
        @Override
        public void onMessageSharedContactClicked(@NonNull List<SignalRecipient> choices) {
        ...
        @Override
        public void onInviteSharedContactClicked(@NonNull List<SignalRecipient> choices) {
            if (getContext() == null) return;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CODE_ADD_EDIT_CONTACT && getContext() != null) {
            MuzimaApplication.getInstance(getContext().getApplicationContext())
                    .getJobManager()
