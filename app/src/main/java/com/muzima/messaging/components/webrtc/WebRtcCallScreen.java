package com.muzima.messaging.components.webrtc;
...
public class WebRtcCallScreen extends FrameLayout implements RecipientModifiedListener {
    ...
    public void setActiveCall(@NonNull SignalRecipient personInfo, @NonNull String message, @Nullable String sas) {
    ...
    public void setActiveCall(@NonNull SignalRecipient personInfo, @NonNull String message) {
        setCard(personInfo, message);
        incomingCallButton.stopRingingAnimation();
        incomingCallButton.setVisibility(View.GONE);
        endCallButton.show();
    ...
    private void setPersonInfo(final @NonNull SignalRecipient recipient) {
    ...
    private void setCard(SignalRecipient recipient, String status) {
