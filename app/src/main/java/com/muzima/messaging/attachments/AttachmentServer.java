package com.muzima.messaging.attachments;
        ...
        public boolean processRequest() throws IOException {
...

            {
                ...
                while (read > 0) {
                    ...
                    if (splitByte > 0)
                        break;
                    read = inputStream.read(buffer, readLength, bufferSize - readLength);
                }
            }

            // Create a BufferedReader for parsing the header.
            ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(buffer, 0, readLength);
            ...
            try {
                decodeHeader(bufferedReader, request, parameters, requestHeaders);
