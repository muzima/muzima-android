package com.muzima.messaging.imaging;
...
public class LongClickCopySpan extends URLSpan {
    ...
    public void onLongClick(View widget) {
        ...
        Toast.makeText(context,
                context.getString(R.string.hint_copied, preparedUrl), Toast.LENGTH_SHORT).show();
    }
    ...
    public void setHighlighted(boolean highlighted, @ColorInt int highlightColor) {
