...
public class SaveAttachmentTask extends ProgressDialogAsyncTask<SaveAttachmentTask.Attachment, Void, Pair<Integer, String>> {
    ...
    private @Nullable
    String saveAttachment(Context context, Attachment attachment)
    ...
    public static void showWarningDialog(Context context, DialogInterface.OnClickListener onAcceptListener) {
