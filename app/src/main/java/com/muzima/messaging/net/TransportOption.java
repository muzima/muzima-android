package com.muzima.messaging.net;
...
import com.muzima.messaging.utils.CharacterCalculator.CharacterState;
...
public class TransportOption implements Parcelable {
    ...
    private final @NonNull
    Optional<CharSequence> simName;
    private final @NonNull
    Optional<Integer> simSubscriptionId;
