package com.muzima.messaging.provider;
...
public class PersistentBlobProvider {
    ...
    private static final String URI_STRING = "content://com.muzima/capture-new";
    ...
    public @NonNull
    InputStream getStream(@NonNull Context context, long id) throws IOException {
    ...
    public static @Nullable
    String getFileName(@NonNull Context context, @NonNull Uri persistentBlobUri) {
        if (!isAuthority(context, persistentBlobUri)) return null;
