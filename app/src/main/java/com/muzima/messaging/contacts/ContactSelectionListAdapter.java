...
import com.muzima.messaging.contacts.ContactSelectionListAdapter.ViewHolder;
import com.muzima.messaging.contacts.ContactSelectionListAdapter.HeaderViewHolder;
...
public class ContactSelectionListAdapter extends CursorRecyclerViewAdapter<ViewHolder>
        ...
        StickyHeaderDecoration.StickyHeaderAdapter<HeaderViewHolder> {
    ...
    private CharSequence getSpannedHeaderString(int position) {
        ...
        if (isPush(position)) {
            ...
            spannable.setSpan(new ForegroundColorSpan(getContext().getResources().getColor(R.color.primary_blue)), 0, headerString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            return spannable;
        } else {
            return headerString;
        }
