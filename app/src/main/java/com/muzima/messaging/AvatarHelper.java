...
public class AvatarHelper {
    ...
    public static InputStream getInputStreamFor(@NonNull Context context, @NonNull SignalAddress address)
            throws IOException
    {
    ...
    public static @NonNull File getAvatarFile(@NonNull Context context, @NonNull SignalAddress address) {
        File avatarDirectory = new File(context.getFilesDir(), AVATAR_DIRECTORY);
    ...
    public static void setAvatar(@NonNull Context context, @NonNull SignalAddress address, @Nullable byte[] data)
            throws IOException
    {
        if (data == null)  {
