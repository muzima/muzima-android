...
import com.muzima.messaging.giph.GiphyProxySelector;
...
public class OkHttpUrlLoader implements ModelLoader<GlideUrl, InputStream> {
    ...
    @Nullable
    @Override
    public ModelLoader.LoadData<InputStream> buildLoadData(GlideUrl glideUrl, int width, int height, Options options) {
