...
public class ReportSummaryActivity extends BroadcastListenerActivity implements ListAdapter.BackgroundListQueryTaskListener {
    ...
    private void setUpEncounterObservations(){
        ...
        encounterObservationsAdapter = new EncounterObservationsAdapter(ReportSummaryActivity.this,R.layout.item_encounter_observation,
