...
import com.muzima.view.forms.UploadFormIntent;
...
public class ReportsActivity_forms extends FormsActivityBase {
    private static final String TAG = "ReportsActivity_forms";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = (DrawerLayout) getLayoutInflater().inflate(R.layout.activity_reports, null);
