...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorTextColor = 0xFFFFFF;
    ...
    private int selectedTextColor = 0xFF666666;
    private Typeface tabTypeface = null;
    private int tabTypefaceStyle = Typeface.BOLD;

    private int lastScrollX = 0;

    private int tabBackgroundResId = R.drawable.page_indicator_tab_selector;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_tabCustomBackground, tabBackgroundResId);
