...
public class PatientJSONMapperTest {
    ...
    public void shouldContainAMRSIdOfPatient() throws Exception {
        String resultJSON = mapper.map(patient().withIdentifier("id").instance());
    ...
    public void shouldContainEmptyStringIfAnyStringAttributeIsMissing() throws Exception {
        String resultJSON = mapper.map(patient().instance());
    ...
    public void shouldContainBirthDateIfPresent() throws Exception {
        ...
        String resultJSON = mapper.map(patient().withBirthdate(currentDate).instance());
    ...
    public void shouldContainFamilyName() throws Exception {
        String resultJSON = mapper.map(patient().withFamilyName("familyName").instance());
    ...
    public void shouldContainGivenName() throws Exception {
        String resultJSON = mapper.map(patient().withGivenName("givenName").instance());
    ...
    public void shouldContainMiddleName() throws Exception {
        String resultJSON = mapper.map(patient().withMiddleName("middleName").instance());
    ...
    public void shouldContainGender() throws Exception {
        String resultJSON = mapper.map(patient().withSex("f").instance());
