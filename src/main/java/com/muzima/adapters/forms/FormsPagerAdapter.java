...
public class FormsPagerAdapter extends MuzimaPagerAdapter implements TagsListAdapter.TagsChangedListener {
    ...
    public void initPagerViews() {
        ...
        pagers[TAB_All] = new PagerView(context.getString(R.string.info_all_templates_available), allAvailableFormsListFragment);
        pagers[TAB_DOWNLOADED] = new PagerView(context.getString(R.string.info_form_template_download), downloadedFormsListFragment);
