...
//    private View mCaptionContainer;
    ...
    public void captureImage(View view) {
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(),getString(R.string.error_image_capturing_activity_find), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void chooseImage(View view) {
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(),getString(R.string.error_image_choosing_activity_find), Toast.LENGTH_SHORT).show();
        }
    }
                ...
                public void onClick(View v) {
                    ...
                    if (c.getCount() > 0) {
                        ...
                        try {
                            ...
                            Toast.makeText(getApplicationContext(),getString(R.string.error_image_viewing_activity_find), Toast.LENGTH_SHORT).show();
                        }
                    }
                    c.close();
                }
