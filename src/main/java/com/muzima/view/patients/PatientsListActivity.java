...
public class PatientsListActivity extends BroadcastListenerActivity implements AdapterView.OnItemClickListener, ListAdapter.BackgroundListQueryTaskListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView = (SearchView) menu.findItem(R.id.search)
                .getActionView();
        searchView.setQueryHint(getString(R.string.info_client_search));
    ...
    private void setupNoDataView() {
        ...
        noDataMsgTextView.setText(getResources().getText(R.string.info_client_local_search_unmatched));

        TextView noDataTipTextView = (TextView) findViewById(R.id.no_data_tip);
        noDataTipTextView.setText(R.string.hint_client_local_search_unmatched);
