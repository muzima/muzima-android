...
public class NotificationsListActivity extends NotificationActivityBase {
        ...
        switch (item.getItemId()) {
            case R.id.menu_load:
                if (notificationsSyncInProgress) {
                    Toast.makeText(this, R.string.error_request_unallowed_while_syncing, Toast.LENGTH_SHORT).show();
                    return true;
                }
    ...
    private void syncAllNotificationsInBackgroundService() {
        ...
        if (authenticatedUser != null) {
            ...
            Toast.makeText(this, getString(R.string.error_notifications_download), Toast.LENGTH_SHORT).show();
    }
